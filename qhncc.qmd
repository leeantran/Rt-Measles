...
plot_rt <- function(data){
  ...
  ggplot(df_plot, aes(x = dates)) +
    ...
    annotate(
    "segment", x = as.Date("2024-09-16"), xend = as.Date("2024-09-16"),
    y = 7, yend = 0, color = "black", size = 1) +
  geom_rect(aes(xmin = as.Date("2024-09-16"), xmax = as.Date("2024-09-16") + 3, ymin = 5, ymax = 7), fill = "#42CAFD") +
  annotate("text", x = as.Date("2024-09-16") + 0.5, y = 6, label = "Vaccination\nfor < 10y",
           color = "black",
           hjust = 0, size = 8 / .pt)
}
```
