...
df1 <- read_xlsx("C:/Users/Admin/Desktop/measles/data/data_updated_v3.xlsx", sheet = "data")
...
df <- df[,c("dates", "ngaynv", "ngaybc", "cd", "qh", "ngaysinh")]

df_kpbc <- df[!is.na(df$cd), c("dates", "ngaynv", "ngaybc", "ngaysinh", "qh")]

df_kpbc$delay <- time_length(interval(df_kpbc$dates,
                                      df_kpbc$ngaybc), "day")

df_kpbc_nor <- filter(df_kpbc, delay >= 0 & delay <= 9)
mean(df_kpbc_nor$delay)

df_kpbc_abnor1 <- filter(df_kpbc, delay < 0)
df_kpbc_abnor2 <- filter(df_kpbc, delay > 9)
df_kpbc_missing <- filter(df_kpbc, is.na(dates))

df_kpbc_abnor1 <- df_kpbc_abnor1 %>%
  mutate(dates = ngaybc - days(3))

df_kpbc_abnor2 <- df_kpbc_abnor2 %>%
  mutate(dates = ngaybc - days(3))

df_kpbc_missing <- df_kpbc_missing %>%
  mutate(dates = ngaybc - days(3))

df <- bind_rows(df_kpbc_nor, df_kpbc_abnor1,
                df_kpbc_abnor2, df_kpbc_missing)
```
...
plot_rt <- function(data){
  ...
  ggplot(df_plot, aes(x = dates)) +
    ...
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week",
                 limits = c(ymd("2024-06-10", ymd("2024-10-05")))) +
...
plot_rt <- function(data){
  ...
  ggplot(df_plot, aes(x = dates)) +
    ...
    theme(axis.text.x = element_text(angle = 60, hjust = 1, size = 10),
          ...
          legend.position = "none") +
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week",
                 limits = c(ymd("2024-07-01", ymd("2024-10-05")))) +
    scale_y_continuous(expand = c(0,0)) +
    scale_fill_manual(values = col) +
    scale_color_manual(values = col) + 
    annotate(
...
p_hist <- ggplot(df_filter_plot, aes(x = dates)) +
    ...
    scale_fill_manual(values = "#87A2FF") +
    scale_color_manual(values = "#E78F81") +
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week",  limits = c(ymd("2024-07-01", ymd("2024-10-05"))))
...
p_hist <- ggplot(df_filter, aes(x = dates, y = I)) +
  geom_histogram(aes(y = I, fill = "Cases"), stat = "identity", binwidth = 1, width = 1) +
    ...
    scale_fill_manual(values = "#87A2FF") +
    scale_color_manual(values = "#E78F81") + 
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week", limits = c(ymd("2024-06-10", ymd("2024-10-05"))))
...
plot_rt <- function(data){
  ...
  ggplot(df_plot, aes(x = dates)) +
    ...
    theme(axis.text.x = element_text(angle = 60, hjust = 1, size = 10),
          ...
          legend.position = "none") +
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week",
                 limits = c(ymd("2024-07-08", ymd("2024-10-05")))) +
    scale_y_continuous(expand = c(0,0)) +
    scale_fill_manual(values = col) +
    scale_color_manual(values = col) + 
    annotate(
...
p_hist <- ggplot(df_filter_plot, aes(x = dates, y = I)) +
    ...
    scale_fill_manual(values = "#87A2FF") +
    scale_color_manual(values = "#E78F81") + 
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week",  limits = c(ymd("2024-07-08", ymd("2024-10-05"))))
...
plot_rt <- function(data){
  ...
  ggplot(df_plot, aes(x = dates)) +
    ...
    theme(axis.text.x = element_text(angle = 60, hjust = 1, size = 10),
          ...
          legend.position = "none") +
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week",
                 limits = c(ymd("2024-08-11", ymd("2024-10-05")))) +
    scale_y_continuous(expand = c(0,0)) +
    scale_fill_manual(values = col) +
    scale_color_manual(values = col) + 
    annotate(
...
p_hist <- ggplot(df_filter, aes(x = dates, y = I)) +
    ...
    scale_fill_manual(values = "#87A2FF") +
    scale_color_manual(values = "#E78F81") + 
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week", limits = c(ymd("2024-08-11", ymd("2024-10-05"))))
...
plot_rt <- function(data){
  ...
  ggplot(df_plot, aes(x = dates)) +
    ...
    theme(axis.text.x = element_text(angle = 60, hjust = 1, size = 10),
          ...
          legend.position = "none") +
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week",
                 limits = c(ymd("2024-08-30", ymd("2024-10-05")))) +
    scale_y_continuous(expand = c(0,0)) +
    scale_fill_manual(values = col) +
    scale_color_manual(values = col) + 
    annotate(
...
p_hist <- ggplot(df_filter_plot, aes(x = dates, y = I)) +
    ...
    scale_fill_manual(values = "#87A2FF") +
    scale_color_manual(values = "#E78F81") + 
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week", limits = c(ymd("2024-08-30", ymd("2024-10-05"))))
...
plot_rt <- function(data){
  ...
  ggplot(df_plot, aes(x = dates)) +
    ...
    theme(axis.text.x = element_text(angle = 60, hjust = 1, size = 10),
          ...
          legend.position = "none") +
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week",
                 limits = c(ymd("2024-08-16", ymd("2024-10-05")))) +
    scale_y_continuous(expand = c(0,0)) +
    scale_fill_manual(values = col) +
    scale_color_manual(values = col) + 
    annotate(
...
p_hist <- ggplot(df_filter, aes(x = dates, y = I)) +
    ...
    scale_fill_manual(values = "#87A2FF") +
    scale_color_manual(values = "#E78F81") + 
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week", limits = c(ymd("2024-08-16", ymd("2024-10-05"))))
...
p_hist <- ggplot(df_filter_plot, aes(x = dates, y = I)) +
    ...
    scale_fill_manual(values = "#87A2FF") +
    scale_color_manual(values = "#E78F81") + 
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week", limits = c(ymd("2024-09-02", ymd("2024-10-05"))))
...
df_qh <- filter(df, qh == "Củ Chi" | qh == "CỦ CHI")
...
plot_rt <- function(data){
  ...
  ggplot(df_plot, aes(x = dates)) +
    ...
    theme(axis.text.x = element_text(angle = 60, hjust = 1, size = 10),
          ...
          legend.position = "none") +
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week",
                 limits = c(ymd("2024-08-12", ymd("2024-10-05")))) +
    scale_y_continuous(expand = c(0,0)) +
    scale_fill_manual(values = col) +
    scale_color_manual(values = col) + 
    annotate(
...
plot_rt <- function(data){
  ...
  ggplot(df_plot, aes(x = dates)) +
    ...
    theme(axis.text.x = element_text(angle = 60, hjust = 1, size = 10),
          ...
          legend.position = "none") +
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week",
                 limits = c(ymd("2024-09-02", ymd("2024-10-05")))) +
    scale_y_continuous(expand = c(0,0)) +
    scale_fill_manual(values = col) +
    scale_color_manual(values = col) + 
    annotate(
...
plot_rt <- function(data){
  ...
  ggplot(df_plot, aes(x = dates)) +
    ...
    theme(axis.text.x = element_text(angle = 60, hjust = 1, size = 10),
          ...
          legend.position = "none") +
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week",
                 limits = c(ymd("2024-08-05", ymd("2024-10-05")))) +
    scale_y_continuous(expand = c(0,0)) +
    scale_fill_manual(values = col) +
    scale_color_manual(values = col) + 
    annotate(
...
p_hist <- ggplot(df_filter, aes(x = dates, y = I)) +
    ...
    scale_fill_manual(values = "#87A2FF") +
    scale_color_manual(values = "#E78F81") + 
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week", limits = c(ymd("2024-08-05", ymd("2024-10-05"))))
...
plot_rt <- function(data){
  ...
  ggplot(df_plot, aes(x = dates)) +
    ...
    theme(axis.text.x = element_text(angle = 60, hjust = 1, size = 10),
          ...
          legend.position = "none") +
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week",
                 limits = c(ymd("2024-08-25", ymd("2024-10-05")))) +
    scale_y_continuous(expand = c(0,0)) +
    scale_fill_manual(values = col) +
    scale_color_manual(values = col) + 
    annotate(
...
p_hist <- ggplot(df_filter_plot, aes(x = dates, y = I)) +
    ...
    scale_fill_manual(values = "#87A2FF") +
    scale_color_manual(values = "#E78F81") + 
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week", limits = c(ymd("2024-08-25", ymd("2024-10-05"))))
...
plot_rt <- function(data){
  ...
  ggplot(df_plot, aes(x = dates)) +
    ...
    theme(axis.text.x = element_text(angle = 60, hjust = 1, size = 10),
          ...
          legend.position = "none") +
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week",
                 limits = c(ymd("2024-08-18", ymd("2024-10-05")))) +
    scale_y_continuous(expand = c(0,0)) +
    scale_fill_manual(values = col) +
    scale_color_manual(values = col) + 
    annotate(
...
p_hist <- ggplot(df_filter, aes(x = dates, y = I)) +
    ...
    scale_fill_manual(values = "#87A2FF") +
    scale_color_manual(values = "#E78F81") + 
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week", limits = c(ymd("2024-08-18", ymd("2024-10-05"))))
...
plot_rt <- function(data){
  ...
  ggplot(df_plot, aes(x = dates)) +
    ...
    theme(axis.text.x = element_text(angle = 60, hjust = 1, size = 10),
          ...
          legend.position = "none") +
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week",
                 limits = c(ymd("2024-09-07", ymd("2024-10-05")))) +
    scale_y_continuous(expand = c(0,0)) +
    scale_fill_manual(values = col) +
    scale_color_manual(values = col) + 
    annotate(
...
p_hist <- ggplot(df_filter_plot, aes(x = dates, y = I)) +
    ...
    scale_fill_manual(values = "#87A2FF") +
    scale_color_manual(values = "#E78F81") + 
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week", limits = c(ymd("2024-09-07", ymd("2024-10-05"))))
...
plot_rt <- function(data){
  ...
  ggplot(df_plot, aes(x = dates)) +
    ...
    theme(axis.text.x = element_text(angle = 60, hjust = 1, size = 10),
          ...
          legend.position = "none") +
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week",
                 limits = c(ymd("2024-08-24", ymd("2024-10-05")))) +
    scale_y_continuous(expand = c(0,0)) +
    scale_fill_manual(values = col) +
    scale_color_manual(values = col) + 
    annotate(
...
plot_rt <- function(data){
  ...
  ggplot(df_plot, aes(x = dates)) +
    ...
    theme(axis.text.x = element_text(angle = 60, hjust = 1, size = 10),
          ...
          legend.position = "none") +
    scale_x_date(date_labels = "%b %d", date_breaks = "1 week",
                 limits = c(ymd("2024-09-09", ymd("2024-10-05")))) +
    scale_y_continuous(expand = c(0,0)) +
    scale_fill_manual(values = col) +
    scale_color_manual(values = col) + 
    annotate(
