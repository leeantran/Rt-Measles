...
-   TP. Thủ Đức: số ca nhiễm đang tăng R~t~ = 0,75 (0,54 - 1,69).

-   Quận 8: số ca nhiễm đang tăng Rt = 1,19 (0,69 - 1,82).

-   Huyện Củ Chi: số ca nhiễm đang tăng R~t~ = 0,44 (0,21 - 0,75).

-   Quận Bình Tân: số ca nhiễm có thể tăng R~t~ = 1,53 (1,14 - 1,98).

-   Quận 12: số ca nhiễm ổn định R~t~ = 1,29 (0,77 - 1,93).
...
p_hist <- ggplot(df_new, aes(x = week)) +
    ...
    scale_x_continuous(breaks = seq(20, 44, by = 1), limits = c(20, 42))
